...
const data = JSON.parse(fs.readFileSync('batch3_with_social_211-310.json', 'utf-8'));
...
fs.writeFileSync('batch3_final_211-310.json', JSON.stringify(transformed, null, 2), 'utf-8');
