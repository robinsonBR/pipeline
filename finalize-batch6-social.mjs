...
const data = JSON.parse(fs.readFileSync('batch6_with_social_511-591.json', 'utf-8'));
...
fs.writeFileSync('batch6_final_511-591.json', JSON.stringify(transformed, null, 2), 'utf-8');
