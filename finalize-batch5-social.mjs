...
const data = JSON.parse(fs.readFileSync('batch5_with_social_411-510.json', 'utf-8'));
...
fs.writeFileSync('batch5_final_411-510.json', JSON.stringify(transformed, null, 2), 'utf-8');
